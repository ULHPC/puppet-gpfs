...
By default, the [puppet-gpfs](https://github.com/ULHPC/puppet-gpfs) repository is bound to the [ulhpc-puppet-gpfs](http://ulhpc-puppet-gpfs.rtfd.org) project on Read the Docs (to avoid confusion with other gpfs projects). 
